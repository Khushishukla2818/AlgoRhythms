    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl w-full flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col items-center md:items-start space-y-4 md:w-1/2">
          ...
          <div className="pt-8 w-full">
            ...
            <div className="flex space-x-4 mt-2">
              <Link to="https://www.linkedin.com/in/khushi2818/" className="text-blue-600">
                <BsLinkedin size={32} />
              </Link>
              <Link to="https://x.com/shukla_khu55616" className="text-blue-400">
                <BsTwitter size={32} />
              </Link>
              <Link to="https://github.com/Khushishukla2818" className="text-gray-800">
                <BsGithub size={32} />
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center md:w-1/2 mt-8 md:mt-0">
          <img
            src="https://avatars.githubusercontent.com/u/149226589?s=96&v=4"
            alt="Profile"
